...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SNLI Async DIIN Training")
    ...
    model_conf = ADIN_encoder_conf(Lang, embedding_matrix,**conf_kwargs)

    model = SNLI_char_emb(ADIN, model_conf, hparams)
