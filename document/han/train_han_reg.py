...
if __name__ == "__main__":
    ...
    if args.save:
        MODEL_PATH = "./models/document_imdb_han_reg/"
        ...
        with open(MODEL_PATH + "lang.pkl", "wb") as f:
            pickle.dump(Lang, f)
        shutil.make_archive("./models/document_imdb_han_reg", "zip", "./models/document_imdb_han_reg")
        neptune_logger.experiment.log_artifact("./models/document_imdb_han_reg.zip")
